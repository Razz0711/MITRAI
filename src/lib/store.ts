...
const seedStudents: StudentProfile[] = [
  ...
  },
  {
    ...
    currentStudy: 'B.Tech Mathematics & Computing',
    institution: 'SVNIT Surat',
    yearLevel: '3rd Year',
    targetExam: 'Semester Exams',
    targetDate: '2026-05-10',
    strongSubjects: ['Real Analysis', 'Abstract Algebra', 'Numerical Methods'],
    weakSubjects: ['Computer Networks', 'Operating Systems'],
    currentlyStudying: 'Complex Analysis',
    upcomingTopics: ['Optimization', 'Partial Differential Equations'],
    learningType: 'reading',
    ...
    accountabilityNeed: 'high',
    videoCallComfort: true,
    shortTermGoal: 'Score 9.5 SGPA in Complex Analysis and Algebra',
    longTermGoal: 'Get into a quant firm or pursue MS in Applied Math',
    studyHoursTarget: 5,
