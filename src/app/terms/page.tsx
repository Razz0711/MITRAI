    ...
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p className="text-xs text-[var(--muted)] leading-relaxed">
          By accessing and using MitrAI (&quot;the Platform&quot;), you agree to be bound by these Terms of Service. 
          MitrAI is an AI-powered study buddy matching platform exclusively for students of Sardar Vallabhbhai 
      ...
      <section className="space-y-3">
        ...
        <p className="text-xs text-[var(--muted)] leading-relaxed">
          ...
          right to share it. MitrAI does not claim ownership of your content but reserves the right to remove 
      ...
      <section className="space-y-3">
        ...
        <p className="text-xs text-[var(--muted)] leading-relaxed">
          MitrAI uses artificial intelligence for matching, study plans, and session chat. AI-generated content 
      ...
      <section className="space-y-3">
        ...
        <p className="text-xs text-[var(--muted)] leading-relaxed">
          MitrAI is provided &quot;as is&quot; without warranties of any kind. We do not guarantee the availability, 
