...
export default function FeedbackPage() {
    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-4 pb-28">
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-sm text-[var(--muted-strong)] max-w-xs">Your feedback helps us make MitrrAi better for everyone at SVNIT.</p>
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-4 pb-28">
      ...
      {/* Type selection */}
      <p className="text-xs text-[var(--muted-strong)] mb-3 px-1">What type of feedback?</p>
      ...
      {/* Message */}
      <p className="text-xs text-[var(--muted-strong)] mb-2 px-1">Your message</p>
      <textarea
        value={message}
      ...
      />
      <p className="text-[11px] text-[var(--muted-strong)] text-right mb-5">{message.length}/500</p>
