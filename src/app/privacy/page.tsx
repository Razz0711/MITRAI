  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p className="text-xs text-[var(--muted)] leading-relaxed">When you use MitrAI, we collect:</p>
      ...
      <section className="space-y-3">
        ...
        <p className="text-xs text-[var(--muted)] leading-relaxed">
          MitrAI is intended for college students (18+). We do not knowingly collect data from individuals 
