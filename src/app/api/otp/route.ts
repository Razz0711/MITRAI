  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 480px; margin: 0 auto; background: #1a1a2e; border-radius: 16px; overflow: hidden;">
        <div style="background: linear-gradient(135deg, #7c3aed, #a855f7); padding: 32px 24px 24px; text-align: center;">
          <img src="https://mitrai-study.vercel.app/logo.jpg" alt="MitrAI" width="68" style="display: block; margin: 0 auto 14px; border-radius: 18px; box-shadow: 0 4px 20px rgba(0,0,0,0.3); border: 2px solid rgba(255,255,255,0.15);" />
