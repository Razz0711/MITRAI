...
CREATE TABLE IF NOT EXISTS post_reports (
  ...
  reporter_id UUID NOT NULL,   -- Should reference auth.users(id) but keeping loose for now based on app pattern
  post_id UUID NOT NULL,       -- Should reference campus_posts(id)
